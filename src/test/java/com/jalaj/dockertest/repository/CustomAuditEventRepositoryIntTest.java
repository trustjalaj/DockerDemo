package com.jalaj.dockertest.repository;

import com.jalaj.dockertest.CheckingDockerApp;
import com.jalaj.dockertest.config.Constants;
import com.jalaj.dockertest.config.audit.AuditEventConverter;
import com.jalaj.dockertest.domain.PersistentAuditEvent;
...
import static com.jalaj.dockertest.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
